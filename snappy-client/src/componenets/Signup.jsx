...
const Signup = () => {
      ...
      .then((result) => {
        ...
        updateUserProfile(data.email, data.photoURL).then(() => {
          ...
          axiosPublic.post("/users", userInfor).then((response) => {
            ...
            navigate(from, { replaxiosPublicace: true });
          });
        });
      })
      .catch((error) => {
  ...
  return (
    <div className="max-w-md bg-gray-900 shadow w-full mx-auto flex items-center justify-center my-20">
      <div className="mb-5">
        ...
        <div className="text-center space-x-3">
          <button
            ...
            className="btn btn-circle hover:border-yellow bg-yellow text-white">
            <FaGoogle />
          </button>
          <button className="btn btn-circle hover:border-yellow bg-yellow text-white">
            <FaFacebookF />
          </button>
          <button className="btn btn-circle hover:border-yellow bg-yellow text-white">
            <FaGithub />
