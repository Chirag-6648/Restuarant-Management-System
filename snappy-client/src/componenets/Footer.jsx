...
const Footer = () => {
  return (
    <div>
      <footer className="footer bg-gray-950 xl:px-24 py-10 px-4 text-base-content">
        <aside>
          <img src="/logo.png" alt="" className="h-[80px] w-[280px]" />
      ...
      <footer className="footer items-center xl:px-24 px-4 py-4 bg-gray-950">
