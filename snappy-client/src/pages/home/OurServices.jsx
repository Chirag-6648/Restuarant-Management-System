...
const OurServices = () => {
  return (
    <div className="section-container py-16 bg-gray-900">
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <button className="bg-yellow font-semibold btn text-white px-8 py-3 rounded-full hover:border-yellow">
              Explore
            </button>
          </div>
        </div>
        <div className="md:w-1/2">
          <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
            {serviceLists.map((service) => (
              <div
                key={service.id}
                className="shadow-md rounded-xl py-5 px-4 text-center space-y-2 text-green cursor-pointer hover:border hover:border-yellow transition-all duration-200 bg-gray-950">
